<template>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="images/Bee Blog.png" alt="">
            </a>
  ...
  <div class="container mt-5 mb-5">
    <div class="post-container mx-auto" style="max-width: 700px;">
      <h2 class="text-center mb-4">Đăng Bài Viết hoặc Video</h2>
      <form>
        <div class="mb-3">
          <label for="postTitle" class="form-label">Tiêu Đề</label>
          <input type="text" class="form-control" id="postTitle" placeholder="Nhập tiêu đề bài viết hoặc video">
        </div>
        <div class="mb-3">
          <label for="postContent" class="form-label">Nội Dung</label>
          <textarea class="form-control" id="postContent" rows="5" placeholder="Nhập nội dung"></textarea>
        </div>
        <div class="mb-3">
          <label for="postFile" class="form-label">Tải Lên Hình Ảnh hoặc Video</label>
          <input type="file" class="form-control" id="postFile" accept="image/*,video/*">
        </div>
        <div class="mb-3">
