<template>
    ...
    <div class="content clearfix">
        <div class="main-content">
            ...
            <div class="post">
                <img src="/src/assets/images/banner2.webp" alt="" class="post-images">
                <div class="post-preview">
                    <h2><router-link to="/post/1">Nội dung bài viết</router-link></h2>
                    <i class="far fa-user"><span>Đức Hiền</span></i>
                    &nbsp;
                    <i class="fas fa-calendar-alt"><span>November 15, 2024</span></i>
                    <p class="preview-text">
                        Bài viết này rất hay
                    </p>
                    <router-link to="/details" class="btn read-more">Read More</router-link>
                </div>
            </div>
            <div class="post">
                <img src="/src/assets/images/banner2.webp" alt="" class="post-images">
                <div class="post-preview">
                    <h2><router-link to="/post/2">Nội dung bài viết</router-link></h2>
                    <i class="far fa-user"><span>Đức Hiền</span></i>
                    &nbsp;
                    <i class="fas fa-calendar-alt"><span>November 15, 2024</span></i>
                    <p class="preview-text">
            ...
            <div class="post">
                <img src="/src/assets/images/banner2.webp" alt="" class="post-images">
                <div class="post-preview">
                    <h2><router-link to="/post/3">Nội dung bài viết</router-link></h2>
                    <i class="far fa-user"><span>Đức Hiền</span></i>
                    &nbsp;
                    <i class="fas fa-calendar-alt"><span>November 15, 2024</span></i>
                    <p class="preview-text">
