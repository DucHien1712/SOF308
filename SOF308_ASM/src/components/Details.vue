    ...
    <div class="content clearfix">
        <div class="main-content single">
            ...
            <div class="post-content">
                <p>Khái niệm đoạn văn ở trường phổ thông hiện nay được hiểu theo nhiều cách khác nhau:</p>
                <p>Khái niệm đoạn văn ở trường phổ thông hiện nay được hiểu theo nhiều cách khác nhau:</p>
                <p>Khái niệm đoạn văn ở trường phổ thông hiện nay được hiểu theo nhiều cách khác nhau:</p>
                <p>Khái niệm đoạn văn ở trường phổ thông hiện nay được hiểu theo nhiều cách khác nhau:</p>
                <p>Khái niệm đoạn văn ở trường phổ thông hiện nay được hiểu theo nhiều cách khác nhau:</p>
        ...
        <div class="sidebar single">
            <div class="section popular">
                ...
                <div class="post clearfix">
                    <img src="/src/assets/images/banner2.webp" alt="">
                    <a href="" class="title"><h4>Content</h4></a>
                </div>
                <div class="post clearfix">
                    <img src="/src/assets/images/banner2.webp" alt="">
                    <a href="" class="title"><h4>Content</h4></a>
